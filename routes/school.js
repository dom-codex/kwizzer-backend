...
router.get("/whitelist/exam", examControllers.whitelist);
router.get("/get/whitelist", examControllers.getWhitelist);
router.post("/whitelist/add", examControllers.addToWhiteList);
router.post("/whitelist/remove", examControllers.removefromWhiteList);
router.get("/whitelist/remove/all", examControllers.removeAllFromWhiteList);
